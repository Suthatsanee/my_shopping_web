...
if(isset($_POST['edit_product'])){
	...
	if(move_uploaded_file($_FILES["image"]["tmp_name"],"../product-images/".$code1."."."jpg")){
		
	$image = "product-images/".$code1."."."jpg";
	$str ="UPDATE `tblproduct` SET `name` = '$name', `code` = '$code', `image` = '$image', `price` = '$price', `tproid` = '$type', `unit` = '$unit', `sale` = '$sale' WHERE `tblproduct`.`code` = '$code';";
