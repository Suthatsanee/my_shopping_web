...
?>
      <tr>
	    ...
	    <td><?php echo $data['ccompany'];?></td>
        <td><?php echo $data['cmessage'];?></td>
        <td><?php echo $data['ctime'];?></td>

      <td>
          <a href="JavaScript:if(confirm('ลบข้อความนี้ ?')==true)
                   JavaScript:window.location='remove_contact.php?cid=<?=$data['cid'];?>',
                   '',400,320" role="button">
