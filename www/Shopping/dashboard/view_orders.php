...
?>
      <tr>
		...
		<td><?php echo $data['pricetotal'];?></td>
        ...
        <td><?php echo $data['muser'];?></td>
		  ...
		  <td><a  href="JavaScript:window.location='view_orders_detail.php?ordersid=<?=$data['ordersid'];?>',
                   '',400,320" >รายละเอียด</a></td>
      <td>
          <a href="JavaScript:if(confirm('ลบออร์เดอร์นี้ ?')==true)
                   JavaScript:window.location='remove.php?ordersid=<?=$data['ordersid'];?>',
                   '',400,320" role="button">
