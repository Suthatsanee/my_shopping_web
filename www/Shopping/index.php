...
switch($_GET["action"]) {
	...
	case "add":
		if(!empty($_POST["quantity"])) {
			...
			// ถ้ามีการคลิกสินค้าเดิมซ้ำให้ทำการเพิ่มจำนวนสินค้าเข้าไปอีก 1
						...
						<ul class="nav navbar-nav">
							...
							<li><a href="#">หมวดรองเท้า <span class="caret"></span></a>
								<ul class="dropdown-menu">
									...
									<li><a href="index.php?type=Espadrilles and Wedges">Espadrilles and Wedges</a>
									</li>
								</ul>
							</li>									
      ...
      <div id="sequence" class="seq">
        <div class="seq-screen">
          <ul class="seq-canvas">
            <!-- single slide item -->
            <li>
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/AXOfw9x-hVw" frameborder="0" gesture="media" allowfullscreen></iframe>
				<div class="seq-title">
                <h2 data-seq>Gucci Spring Summer 2020 Fashion Show</h2>
              </div>
            </li>
            <!-- single slide item -->
            <li>
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/H14DatRx0Uo" frameborder="0" gesture="media" allowfullscreen></iframe>
				<div class="seq-title">
                <h2 data-seq>GUCCI ARIA</h2>
              </div>
            </li>
            <!-- single slide item -->
            <li>
              <iframe width="100%" height="100%" src="https://www.youtube.com/embed/cLHuCUJuc1s" frameborder="0" gesture="media" allowfullscreen></iframe>
				<div class="seq-title">
                <h2 data-seq>ประวัติ GUCCI</h2>
              </div>
            </li>
            <!-- single slide item -->
            <!-- single slide item -->
          ...
          <div class="aa-support-area">
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="aa-support-single">
                ...
                <h4>สินค้าเสียหายคือเงินภายใน 30 วัน</h4>
              </div>
            </div>
            <!-- single support -->
            <div class="col-md-4 col-sm-4 col-xs-12">
              <div class="aa-support-single">
                ...
                <h4>ช่วยเหลือเบอร์ 062-167-1615</h4>
              </div>
            </div>
          </div>
        </div>
